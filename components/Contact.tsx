...
const Contact:FunctionComponent = () => {
    return(
            <section id={"#Contact"}className={clsx("m-[20px]", "flex", "flex-col","justify-center", "text-center","items-center")}>
                ...
                <p className={clsx( "flex", "flex-row", "justify-center",)}> or email me directly to ... optimuhs7@gmail.com</p>
            </section>
    )
}
